...
def read_data_2d_box(minTaskNumber, maxTaskNumber,  data_source, baseline_data_index, main_data_index):
    data_2d = {}
...
if __name__ == "__main__":
    data_box_plot = read_data_2d_box(minTaskNumber, maxTaskNumber,  data_source, baseline_data_index,
                                     main_data_index)
