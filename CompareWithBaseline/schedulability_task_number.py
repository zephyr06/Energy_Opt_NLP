...
if __name__ == "__main__":
    ...
    task_number_list = range(5, task_number + 1)

    plot_energy(energy_saving_ratio, task_number_list, "Compare_energy_" + title, x_label, y_label)

    plot_energy(time_list, task_number_list, "Compare_Running_time_" + title, x_label, "Running time ratio")
