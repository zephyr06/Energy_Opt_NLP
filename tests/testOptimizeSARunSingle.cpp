...
TEST(SA, v1) {
    ...
    // // auto res = OptimizeSchedulingSA<rt_num_opt::DAG_Nasri19,
    ...
    // "seconds"
    //      << endl;
    // cout << "The error before optimization is " << Color::green
    //      << res.initialError << Color::def << endl;
    // cout << "The error after optimization is " << Color::green
    //      << res.optimizeError << Color::def << endl;
    // cout << "The result after optimization is " << Color::blue
    //      << res.optimizeVariable << Color::def << endl;
}
int main() {
    TestResult tr;
