...
// TEST(GP_FP_FTP_Narsi19, v1)
// {
//     std::string path = "/home/zephyr/Programming/Energy_Opt_NLP/TaskData/test_n5_v34.csv";
//     auto tasksetVerucchi = rt_num_opt::TransformTaskSetNumOpt2dagSched(path);
//     int n_proc = 2;
//     std::cout << std::endl
//               << "\tFonseca 2019 constrained (GP-FP-FTP): " << dagSched::GP_FP_FTP_Narsi19(tasksetVerucchi, n_proc) << std::endl;
// }

// TEST(GP_FP_FTP_Narsi19, v2)
// {
...
//     std::cout << std::endl
//               << "\tFonseca 2019 constrained (GP-FP-FTP): " << dagSched::GP_FP_FTP_Narsi19(tasksetVerucchi, n_proc) << std::endl;
//     EXPECT_LONGS_EQUAL(15, dagSched::RTA_Narsi19(tasksetVerucchi, n_proc)[0]);
// }
// TEST(rta, v1)
// {
//     std::string path = "/home/zephyr/Programming/Energy_Opt_NLP/TaskData/test_n8_v1.csv";
//     rt_num_opt::DAG_Model dagTasks = rt_num_opt::ReadDAG_Task(path, "RM");
//     rt_num_opt::RTA_Narsi19 r(dagTasks);
